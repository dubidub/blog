...
{% include embed.html url="https://dubidub.github.io/tp_transportation_network/resources/plain_degree_centrality" %}
...
|    | Top10_origin  | Top10_destination  |   edge_betweenness |
|----|---------------|--------------------|--------------------|
